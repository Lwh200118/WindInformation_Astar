...
def generate_map_and_mark_centers():
    ...
    for center in centers:
        left_center = (center[0], center[1]-40)
        right_center = (center[0] , center[1]+60)
    ...
    path_x, path_y = read_path_from_dat('Astar_path_D_direct_100_40_to_100_140_R5.dat')
    plt.plot(path_x, path_y, '-r', label='Traditional A* Path')

    # Read and plot improved A* path from DAT file
    path_x, path_y = read_path_from_dat('New_optimized_UW_PM_path_100_40_to_100_140_V16.dat')
