...
def generate_map_and_save_images(output_folder, wind_field_folder, speed, interval, drone_image_path, min_speed, max_speed, traditional_energy_data_file, improved_energy_data_file):
    ...
    traditional_path_x, traditional_path_y = read_path_from_dat(r"E:\UAV\研究计划\TEST\Astar_path_D_direct_130_20_to_130_180_R5.dat")
    improved_path_x, improved_path_y = read_path_from_dat(r"E:\UAV\研究计划\TEST\V8_Instant\New_optimized_UW_PM_path_Instant_130_20_to_130_180_V8UTT_More_Mod_1_0.dat")
    ...
    while current_time <= 5100.0 + total_time + interval:  # 增加一个时间间隔
        ...
        plt.savefig(os.path.join(output_folder, f"More_F13020F130180_10_{current_time - 5100.0:.1f}.png"))  # 使用浮点数格式化
        plt.close()
...
if __name__ == '__main__':
    ...
    traditional_energy_data_file = r"E:\UAV\研究计划\TEST\energy_consumption_Astar_F13020130180.dat"
    improved_energy_data_file = r"E:\UAV\研究计划\TEST\energy_consumption_OP_F13020130180_1.0.dat"
