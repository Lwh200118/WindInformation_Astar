...
# 计算总成本并输出路径信息
def calculate_total_cost_and_output(path, data_dir, output_filename, energy_output_filename, start_time=5100, time_interval=1.0, U_t=8):
    total_cost = 0
    total_distance = 0
    current_time = start_time
    next_output_time = current_time + 1.0
    energy_data = []
...
def main():
    ...
    path_filename = r"E:\UAV\研究计划\TEST\V8_Instant\New_optimized_UW_PM_path_Instant_130_20_to_130_180_V8UTT_More_Mod_1_0.dat"
    output_filename = 'path_cost_output_PM_60_80_to_160_80.csv'
    energy_output_filename = 'energy_consumption_OP_F13020130180_1.0.dat'
