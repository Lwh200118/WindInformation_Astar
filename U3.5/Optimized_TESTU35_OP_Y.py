...
class AStarPlanner:
    ...
    def calc_final_path(self, ngoal, closedset):
        ...
        while parent_index != -1:
            ...
            u = self.interpolate_v(x, y)
            v = self.interpolate_u(x, y)
...
def main():
    filename = r"E:\UAV\研究计划\WindFieldInfo\UMean_H75_h80_V8.dat"
    print(__file__ + '  start!')
    plt.title("Astar_PM_V8_h80_V8_W001")
    sx, sy, gx, gy = 100,20,100,100
    ...
    output_filename = f'New_optimized_UW_Y_PMU35_path_{sx}_{sy}_to_{gx}_{gy}_V8UTT_h80_V_W001.dat'
