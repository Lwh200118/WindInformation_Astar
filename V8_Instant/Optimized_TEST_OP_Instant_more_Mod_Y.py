...
class AStarPlanner:
    ...
    def load_data(self, time):
        folder_name = f"{time:.1f}"  # 修改为保留一位小数的字符串
    ...
    def planning(self, sx, sy, gx, gy):
        ...
        while True:
            ...
            current_time = self.start_time + round(time_elapsed / self.time_interval) * self.time_interval
...
def main():
    ...
    plt.title("Astar_PM_V8_Instant_More_Nod_1.0s")
    sx, sy, gx, gy = 130,20,130,180
    ...
    output_filename = f'New_optimized_UW_PM_path_Instant_{sx}_{sy}_to_{gx}_{gy}_V8UTT_More_Mod_1_0.dat'
